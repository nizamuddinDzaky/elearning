<div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
          <ol class="breadcrumb">
            ...
            <li><a href="#"><?php echo get_phrase('Student');?></a></li>
...
foreach($profile_info as $row):?>
          ...
          <div class="user-bg"> <img src="style/images/large/img.jpg" alt="user" style="100%">
              <div class="overlay-box">
                <div class="user-content"><a href="javascript:void(0)"><img alt="img" class="thumb-lg img-circle" src="<?php echo $this->crud_model->get_image_url('student', $row['student_id']);?>"></a>
            ...
            <div class="panel-body">
               <?php $edit_data = $this->db->get_where('student' , array('student_id' => $student_id))->result_array();
                      foreach ($edit_data as $row2):
                ?>
                    <?php echo form_open(base_url() . 'index.php?admin/student/do_update/'.$row2['student_id'], array('class' => 'form-horizontal form-groups-bordered validate ajax-submit', 'enctype' => 'multipart/form-data'));?>
                                        ...
                                        <option value=""><?php echo get_phrase('Select'); ?></option>
                                            <?php 
                                                ...
                                                foreach($parents as $row): ?>
                                                      <option value="<?php echo $row['parent_id'];?>" selected = "<?= ($row['parent_id'] == $row2['parent_id']) ? 'selected' : ''?>">
                                                  <?php echo $row['name'];?>
                                         </option>
                                              <?php endforeach; ?>
                                     </select>
              ...
              <div class="fileinput fileinput-new" data-provides="fileinput">
                    <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                      <img src="<?php echo $this->crud_model->get_image_url('student' , $row2['student_id']);?>" alt="...">
                    </div>
